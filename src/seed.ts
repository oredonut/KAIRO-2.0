...
export async function seedDatabase() {
  ...
  await db.collection('users').doc(profUser3.id).set(profUser3);
  ...
  await db.collection('professional_profiles').doc(profProfile3.id).set(profProfile3);
  ...
  await db.collection('users').doc(profUser4.id).set(profUser4);
  ...
  await db.collection('professional_profiles').doc(profProfile4.id).set(profProfile4);
