...
exports.ProblemAnalysisSchema = zod_1.z.object({
    ...
    categoryLabel: zod_1.z.string().default('Technical Repair'),
    problemSummary: zod_1.z.string().min(5),
    understanding: zod_1.z.string().default(''),
    likelyFault: zod_1.z.string().default(''),
    requiredSkills: zod_1.z.array(zod_1.z.string()).min(1),
    questions: zod_1.z.array(zod_1.z.object({
        id: zod_1.z.string(),
        label: zod_1.z.string(),
        type: zod_1.z.string().default('chips'),
